      ...
      >
        ...
        >
          <view
            ...
            v-if="textInside && !noData"
          >
            <view>{{ text }}{{ percentage }}%</view>
          </view>
        </view>
        <view
          v-if="!isAnimate"
        ...
        >
          <view
            ...
            v-if="textInside && !noData"
          >
            <view class="text">{{ text }}{{ percentage }}%</view>
          </view>
        </view>
      </view>
      <view>
    ...
    start() {
      if (this.isAnimate) {
        ...
        this.$nextTick(() => {
          ...
          let width =
            style.width.replace("px", "") * ((this.percentage * 1) / 100);
        ...
        container.boundingClientRect().exec((res1) => {
          this.contentWidth =
            res1[0][0].width * 1 * ((this.percentage * 1) / 100).toFixed(2) +
            "px";
        });
      }
    },
